...
### Added
- Enabled the `@typescript-eslint/func-call-spacing`, `computed-property-spacing`, `no-whitespace-before-property`, `rest-spread-spacing` and `semi-spacing` spacing rules by default.
